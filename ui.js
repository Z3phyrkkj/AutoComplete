 ...
 */
window.QuestHelperUI = (() => {
    const LOGO_URL = window.QuestHelperConfig.logoUrl;
        ...
        panel.innerHTML = `
            <div class="qh-header" id="qhDragHandle">
                ...
                <div class="qh-title-block">
                    ...
                    <div class="qh-version">v${window.QuestHelperConfig.version}</div>
                </div>
    ...
    function updateQuestList(quests, taskIcons, utils) {
        ...
        questList.innerHTML = quests.map((quest) => {
            try {
                ...
                const label = window.QuestHelperConfig.taskLabels[taskName] || taskName;
